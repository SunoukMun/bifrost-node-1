...
bifrost-node build-spec --chain dev --raw --disable-default-bootnode > /data/bifrost-dev.json

#Step 3. 키 세팅
## insert aura key
bifrost-node key insert --base-path /data/chain0 \
